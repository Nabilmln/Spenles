...
export default async function DashboardPage({
  ...
  return (
    <div>
      ...
      <div className="-mx-[clamp(1.25rem,4vw,2.75rem)] mt-[1.55rem] max-[860px]:min-h-[calc(100svh)] max-[860px]:rounded-t-[3.5rem] max-[860px]:bg-primary-600 max-[860px]:pt-10 px-7 min-[861px]:mx-0 min-[861px]:mt-3 min-[861px]:rounded-none min-[861px]:bg-transparent min-[861px]:p-0">
        <div className="dashboard-grid grid gap-3 min-[861px]:grid-cols-8 min-[1024px]:grid-cols-12">
          <DashboardFeatureGrid />
